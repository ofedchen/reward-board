...
export function getDefaultRewards(): Reward[] {
  return [
    ...
    { id: 3, name: "something from Flying Tiger", redeemed: false },
    { id: 4, name: "flat white from Alkemisten", redeemed: false },
    { id: 5, name: "WATCH A SKIING VIDEO", redeemed: false },
    { id: 6, name: "play 1 carcassonne game", redeemed: false },
